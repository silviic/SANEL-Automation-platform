                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @if($data->status == "1")
                                            <form action="{{ route('requestproducts', ['order_id' => $data->id]) }}" method="POST" style="margin-top: 20px;">
                                                <button type="submit" class="btn btn-block btn-success" style="margin-top: -10px; margin-left: 10px;">
                                                    <span class="signingin hidden"><span class="voyager-refresh"></span></span>
                                                    <span class="signin">{{ __('Request products') }}</span>
                                            ...
                                            @if($data->status == "2")
                                            <form action="{{ route('requestpayment', ['order_id' => $data->id]) }}" method="POST" style="margin-top: 20px;">
                                                <button type="submit" class="btn btn-block btn-success" style="margin-top: -10px; margin-left: 10px;">
                                                    <span class="signingin hidden"><span class="voyager-refresh"></span></span>
                                                    <span class="signin">{{ __('Request payment') }}</span>
                                                    <input type="hidden" name="_token" value="{{ Session::token() }}">
                                                </button>
                                            </form>
                                            @endif
                                            ...
                                            @if($data->status == "4")
                                            <form action="{{ route('home') }}" method="POST" style="margin-top: 20px;">
                                                <button type="submit" class="btn btn-block btn-success" style="margin-top: -10px; margin-left: 10px;">
                                                    <span class="signingin hidden"><span class="voyager-refresh"></span></span>
                                                    <span class="signin">{{ __('Comfirm order') }}</span>
                                                    <input type="hidden" name="_token" value="{{ Session::token() }}">
                                                </button>
                                            </form>
                                            @endif
