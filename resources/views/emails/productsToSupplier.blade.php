...
<html>
	...
	<body>
        <div class="col-6-md" style="background-color: #007bff; color: #ffffff; padding-top: 5px; padding-bottom: 5px; padding-left: 10px; font-size: 18px; margin-top: 20px;">
            <font face="verdana" size="2px">Jauns pasūtījums no SANEL | Pasūtījuma nr. {{ $order->order_nr }}</font>
        </div>
            
        <div style="margin-top: 25px; margin-bottom: 25px; border: 1px solid #afafaf; padding: 20px;">
             <p>Lūdzam sekojat šai saitei lai precizētu preču pieejamību: <a href="http://blic.test/orders/requestproducts/{{$order->id}}">Preču saraksts</a></p>
